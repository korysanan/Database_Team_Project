...
<link rel="stylesheet" type="text/css" href="./css/board_list_for_hit.css">
...
<section>
   	<div id="board_box">
   		<div id = "btn_group">
			<button id = "recent_btn" onclick="location.href='board_list.php'">최신순</button>
			<button id = "hit_btn">조회순</button>
...
<?php
	...
	$sql = "select * from board order by hit desc, num desc";
...
<?php
	if ($total_page>=2 && $page >= 2)	
	{
   	...
   	for ($i=1; $i<=$total_page; $i++)
   	{
		...
		{
			echo "<li><a href='board_list_for_hit.php?page=$i'> $i </a><li>";
		}
   	}
   	if ($total_page>=2 && $page != $total_page)		
   	{
		$new_page = $page+1;	
		echo "<li> <a href='board_list_for_hit.php?page=$new_page'>다음 ▶</a> </li>";
	}
	else 
		echo "<li>&nbsp;</li>";
?>
