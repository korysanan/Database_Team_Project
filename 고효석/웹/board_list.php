   	...
   	<div id="board_box">
	    ...
	    <ul id="board_list">
				<li>
					...
					<span class="col2">작가</span>
					<span class="col4">공개일</span>
...
?>
				<li>
					<span class="col1"><a href="board_view.php?num=<?=$num?>&page=<?=$page?>"><?=$title?></a></span>
					<span class="col2"><?=$director?></span>
					<span class="col4"><?=$opening_time?></span>
					<span class="col5"><?=$id?></span>
					<span class="col2"><?=$runnings_time."분"?></span>
