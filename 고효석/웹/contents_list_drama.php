...
<link rel="stylesheet" type="text/css" href="./css/contents_list_drama.css">
	   ...
	   <ul id="board_list">
          ...
          <!-- 각각의 게시물 카드 -->
                <?php
                    ...
                    $sql = "select * from contents where division = 'D' order by title asc";
...
<?php
	...
	{
		$new_page = $page-1;
		echo "<li><a href='contents_list_drama.php?page=$new_page'>◀ 이전</a> </li>";
	}		
	else 
		echo "<li>&nbsp;</li>";
   	...
   	for ($i=1; $i<=$total_page; $i++)
   	{
		...
		{
			echo "<li><a href='contents_list_drama.php?page=$i'> $i </a><li>";
		}
   	}
   	if ($total_page>=2 && $page != $total_page)		
   	{
		$new_page = $page+1;	
		echo "<li> <a href='contents_list_drama.php?page=$new_page'>다음 ▶</a> </li>";
	}
	else 
		echo "<li>&nbsp;</li>";
?>
