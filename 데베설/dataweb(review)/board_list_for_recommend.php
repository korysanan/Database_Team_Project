...
<link rel="stylesheet" type="text/css" href="./css/board_list_for_recommend.css">
...
<?php
	if ($total_page>=2 && $page >= 2)	
	{
   	...
   	for ($i=1; $i<=$total_page; $i++)
   	{
		...
		{
			echo "<li><a href='board_list_for_recommend.php?page=$i'> $i </a><li>";
		}
   	}
   	if ($total_page>=2 && $page != $total_page)		
   	{
		$new_page = $page+1;	
		echo "<li> <a href='board_list_for_recommend.php?page=$new_page'>다음 ▶</a> </li>";
	}
	else 
		echo "<li>&nbsp;</li>";
?>
