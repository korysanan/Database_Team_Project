...
<body>
 ...
 <form method = "POST" action = "search.php?search=<?=$search?>" style = "margin-top: 30px;  padding: 10px; border-bottom: solid 2px #516e7f; font-size: 20px;position: relative; width: 800px; margin: 0 auto;" >
